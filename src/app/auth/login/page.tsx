...
const AUTH_HERO_IMAGE =
  'https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=1200&h=1600&q=80&fit=crop&crop=center'
  ...
  return (
    <div className="flex min-h-[calc(100vh-72px)]">
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        ...
        />
        {/* Gradient overlay toward the form side */}
        ...
        <div className="absolute bottom-12 left-10 right-10 z-10">
          ...
          <p className="text-on-surface-variant text-sm max-w-md leading-relaxed">
            Join thousands of analysts using KickOracle for data-driven World Cup insights,
            prediction leagues, and real-time team intelligence.
          </p>
        </div>
            ...
            <div className="relative">
              <div className="text-center mb-8">
                ...
                <h1 className="font-headline text-4xl tracking-tight uppercase mb-2">
                  <span className="text-on-surface">Sign</span>{' '}
                  <span className="text-primary">In</span>
                </h1>
                <p className="text-on-surface-variant text-sm">
                  Access your prediction leagues and leaderboards
                </p>
              </div>
